/**
 * app/api/sop/import/[importId]/original/route.ts
 *
 * Streams the original uploaded SOP file directly from MongoDB GridFS.
...
export async function GET(
  ...
  try {
    ...
    const file = await getFileFromGridFS(record.gridfsFileId.toString(), "document_files");
    if (!file) {
      return NextResponse.json(
