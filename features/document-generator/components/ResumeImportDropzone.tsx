/**
 * features/document-generator/components/ResumeImportDropzone.tsx
 *
 * Minimal drag-and-drop file upload component for resume files (.pdf, .docx).
 */
...
export function ResumeImportDropzone({ onFileSelect, disabled = false }: ResumeImportDropzoneProps) {
  ...
  function validateAndSelect(file: File) {
    ...
    if (!isPdf && !isDocx) {
      setErrorMessage("Unsupported file type. Please upload a PDF or DOCX resume.");
      return;
    }
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Upload your candidate's existing resume in PDF or DOCX format
          </p>
        </div>
